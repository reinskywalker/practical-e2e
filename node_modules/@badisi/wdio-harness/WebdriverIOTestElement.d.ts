 ...
 */
export declare class WebdriverIOTestElement implements TestElement {
    readonly hostElement: WebdriverIO.Element;
    constructor(hostElement: WebdriverIO.Element);
    ...
    private dispatchClickEventSequence;
